...
def valid(args, model, writer, test_loader, global_step):
    ...
    for step, batch in enumerate(epoch_iterator):
        ...
        with torch.no_grad():
            ...
            # eval_loss = loss_bce(logits, y.float())
...
def train(args, model):
    ...
    while True:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # print(all_preds[0].shape, all_label[0].shape)
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % args.eval_every == 0:
                    ...
                    if args.local_rank in [-1, 0]:
                        ...
                        print("best accuracy so far: %f" % best_acc)
                    model.train()
...
def main():
    ...
    parser.add_argument("--dataset", choices=["CUB_200_2011", "car", "dog", "nabirds", "INat2017", 'cats', 'oxford'], default="dog",
                        help="Which dataset.")
    ...
    parser.add_argument('--checkpoint', type=str, default='./output/ST_dog_checkpoint.bin',
