...
from .dataset import dogs, cats, oxford
...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = cats(root=args.data_root,
                                train=True,
                                transform=train_transform
                                )
        testset = cats(root=args.data_root,
                                train=False,
                                transform=test_transform
                                )
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = oxford(root=args.data_root,
                                train=True,
                                transform=train_transform
                                )
        testset = oxford(root=args.data_root,
                                train=False,
                                transform=test_transform
                                )
